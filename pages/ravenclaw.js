        ...
        <>
            ...
            <div className={styles.background}>
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-4">
                            <Image src={Rcrest} width= "300px" height="300px"></Image>
                        </div>
                        <div className="col">
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className={styles.picture}>
                                <Image src={Luna} width="300px" height="200px" className={styles.picture}></Image>
                            </div>
                            <h4 className={styles.text}>Luna Lovegood</h4>
                        </div>
                        <div className="col">
                            <Image src={Ollivander} width="300px" height="200px" className={styles.picture}></Image>
                            <h4 className={styles.text}>Garrick Ollivander</h4>
                        </div>
                        <div className="col">
                            <Image src={Filius} width="300px" height="200px" className={styles.picture}></Image>
