        ...
        <>
            ...
            <div className={styles.background}>
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-4">
                            <Image src={Hcrest} width= "300px" height="300px"></Image>
                        </div>
                        <div className="col">
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className={styles.picture}>
                                <Image src={Lupin} width="300px" height="200px" className={styles.picture}></Image>
                            </div>
                            <h4 className={styles.text}>Remus Lupin</h4>
                        </div>
                        <div className="col">
                            <Image src={Tonks} width="300px" height="200px" className={styles.picture}></Image>
                            <h4 className={styles.text}>Nymphadora Tonks</h4>
                        </div>
                        <div className="col">
                            <Image src={Sprout} width="300px" height="200px" className={styles.picture}></Image>
